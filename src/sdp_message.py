...
from sdp_parser import parse_functions
from sdp_fields import FieldRaw, TimeDescription, MediaDescription
...
class SdpMessage:
    ...
    def from_string(raw_message: str):
        ...
        if not m:
            raise SdpParserError(f"Incorrect SDP header order detected")
